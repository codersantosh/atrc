		...
		},
		{
			...
			svg: ({ className = '' }) => (
				<svg
					...
					viewBox='0 0 1000 100'
					preserveAspectRatio='none'>
					<polygon points='0,0 0,46.7 40.7,23.4 82.5,47.2 124.2,23.4 166,47.2 207.7,23.4 249.4,47.2 291.2,23.4 332.9,47.2 374.7,23.4 416.4,47.2 458.1,23.4 499.9,47.2 541.6,23.4 583.4,47.2 625.1,23.4 666.9,47.2 708.6,23.4 750.3,47.2 792.1,23.4 833.8,47.2 875.6,23.4 917.3,47.2 959,23.4 1000,46.8 1000,0 '></polygon>
					<path
						className='st0'
						d='M499.9,51'></path>
				</svg>
		...
		},
		{
			...
			svg: ({ className = '' }) => (
				<svg
					...
					<path
						className='st1'
						d='M0,1v94.2c256.7-171,917.3-15.6,1000,4.8V1H0z'></path>
					<path d='M0,100h1.3C273.1-106.1,1000,77.4,1000,77.4V0H0V100z'></path>
				</svg>
			),
			value: 'svg-19',
		},
