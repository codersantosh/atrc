import { AtrcLandingTemplate1 } from '../../packages';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
export default {
	title: 'Templates/Landing',
	component: AtrcLandingTemplate1,
};
...
export const Template1 = () => {
	return (
		<>
			<AtrcLandingTemplate1
				notice={{
					on: true,
					text: "Congratulations on choosing the Acme Coming Soon and Maintenance Mode Page for your website Coming Soon or Maintenance Mode. We recommend taking a few minutes to read the following information on how the plugin works. Please read it carefully to fully understand the plugin's capabilities and how to use them effectively.",
				}}
				banner={{
					heading: 'Acme Coming Soon and Maintenance Mode Page',
					leadText:
						"Congratulations! You've successfully installed Acme Coming Soon and Maintenance Mode Page and it's ready for enabling or disabling coming soon or maintenance mode.",
					normalText:
						"If you have any questions or need assistance, please don't hesitate to contact us for support. The Acme Coming Soon and Maintenance Mode Page plugin caters to WordPress site owners, developers and designers seeking to create and display Coming Soon page for their new site or display Maintenance Mode while updating existing sites.",
					buttons: [
						{
					...
					image:
						'https://www.cosmoswp.com/wp-content/uploads/2019/11/starter-sites-1.png',
				}}
				identity={{
					logo: 'https://www.acmeit.org/wp-content/uploads/2020/03/acmeit-logo.png',
					title: 'Acme Coming Soon and Maintenance Mode Page',
					buttons: [
						{
							text: 'Visit site',
							url: 'https://github.com/codersantosh/acme-coming-soon',
				...
				bannerColumns={[
					...
					},
					{
						...
						title: 'Start developing your site',
					},
				]}
				normalColumns={[
					{
					...
					},
					{
						...
						buttonText: 'Visit community page',
						buttonLink: 'https://github.com/codersantosh/acme-coming-soon',
					},
					{
						...
						buttonText: 'Create a support thread',
						buttonLink: 'https://github.com/codersantosh/acme-coming-soon',
					},
					{
