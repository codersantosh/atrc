...
var AtrcPostExcerpt = function AtrcPostExcerpt(props, ref) {
  ...
  var _useEntityProp = (0, _coreData.useEntityProp)('postType', postType, 'excerpt', postId),
  ...
  var excerptContent = !isTrimmed ? rawOrRenderedExcerpt || (0, _i18n.__)('No excerpt found', 'atrc-prefix-atrc') : trimmedExcerpt;
  return /*#__PURE__*/React.createElement(_wrap.default, _extends({}, defaultProps, {
    ref: ref,
    tag: htmlTag
  }), excerptContent);
};
var _default = exports.default = (0, _element.forwardRef)(AtrcPostExcerpt);
