...
var AtrcPostContent = function AtrcPostContent(props, ref) {
  ...
  var hasAlreadyRendered = (0, _blockEditor.__experimentalUseHasRecursion)(postId);
  ...
  if (postId && postType && hasAlreadyRendered) {
    return /*#__PURE__*/React.createElement(_wrap.default, _extends({}, defaultProps, {
      ...
      isDismissible: false,
      autoDismiss: false
    }, (0, _i18n.__)('Block cannot be rendered inside itself.', 'atrc-prefix-atrc')));
  }
  return content !== null && content !== void 0 && content.protected ? /*#__PURE__*/React.createElement(_wrap.default, _extends({}, defaultProps, {
    ref: ref
  }), /*#__PURE__*/React.createElement(_notice.default, {
    isDismissible: false,
    autoDismiss: false
  }, (0, _i18n.__)('This content is password protected.', 'atrc-prefix-atrc'))) : /*#__PURE__*/React.createElement(_wrap.default, _extends({}, defaultProps, {
    ref: ref,
    tag: htmlTag,
...
var _default = exports.default = (0, _element.forwardRef)(AtrcPostContent);
