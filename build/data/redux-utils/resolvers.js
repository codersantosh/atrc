...
export var resolvers = {
   ...
   */
  getData: function getData(key, queryArgs) {
    var hiddenQueryArgsData = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var queryParts, queryKey, result;
   ...
   */
  getItem: /*#__PURE__*/_regeneratorRuntime().mark(function getItem(key, id, atrcStore) {
    var items, result;
    return _regeneratorRuntime().wrap(function getItem$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          items = select(atrcStore).getItems(key);
          result = null;
          if (!items) {
            _context2.next = 6;
            break;
          ...
          _context2.next = 5;
          return find(items, function (itm) {
            return itm.id === parseInt(id);
          });
        case 5:
        ...
        case 6:
          ...
          _context2.next = 9;
          return actions.beforeItemApi({
            key: key
          });
        case 9:
          _context2.next = 11;
          return actions.getItem({
            key: key,
            id: id
          });
        case 11:
  ...
  getSettings: function getSettings(key) {
    var setNotice = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return actions.beforeSettingsApi({
              key: key
            });
          case 2:
            _context3.next = 4;
