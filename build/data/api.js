...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } /* WordPress */ /* Library */ /* Inbuilt */
/* Local */
...
function axiosFetch(options) {
  ...
  if (AtrcApis.baseUrls[key]) {
    ...
    path = AtrcApis.baseUrls['atrc-prefix-atrc-global'] + "/".concat(path);
  }
...
var ClassAtrcApis = /*#__PURE__*/function () {
  ...
  _createClass(ClassAtrcApis, [{
    ...
    key: "baseUrl",
    value: function baseUrl(key, url) {
    ...
    key: "registerType",
    value: function registerType(key, path, type, callback) {
      this.types.push({
        key: key,
        path: path,
        type: type,
    ...
    key: "doApi",
    value: (function () {
      var _doApi = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(key, type, data) {
        var rowId,
          api,
          result,
          response,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              rowId = _args.length > 3 && _args[3] !== undefined ? _args[3] : 0;
            ...
            case 5:
              ...
              _context.prev = 7;
              if (this.XWPNonce) {
                _axios.default.defaults.headers.common['X-WP-Nonce'] = this.XWPNonce;
              }
              _context.t0 = api.type;
              _context.next = _context.t0 === 'getItems' ? 12 : _context.t0 === 'getItem' ? 20 : _context.t0 === 'insertItem' ? 25 : _context.t0 === 'updateItem' ? 31 : _context.t0 === 'deleteItem' ? 37 : _context.t0 === 'getSettings' ? 42 : _context.t0 === 'saveSettings' ? 47 : 53;
              break;
            case 12:
              path = api.path;
              if (data) {
                path = (0, _url.addQueryArgs)(path, data);
              }
              _context.next = 16;
              return axiosFetch({
                key: key,
            ...
            case 16:
              ...
              if (response.headers) {
                if (response.headers.get('X-WP-All-Total')) {
                  result.countAllItems = parseInt(response.headers.get('X-WP-All-Total'));
                }
...
var _default = exports.default = AtrcApis;
