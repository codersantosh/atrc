...
var SixColumnsOptionsCloned = (0, _lodash.cloneDeep)(_options.SixColumnsOptions);
SixColumnsOptionsCloned.push({
  label: (0, _i18n.__)('4-4-4-4-4-4', 'atrc-prefix-atrc'),
  value: '4-4-4-4-4-4',
  icon: function icon() {
...
SixColumnsOptionsCloned.push({
  label: (0, _i18n.__)('6-6-6-6-6-6', 'atrc-prefix-atrc'),
  value: '6-6-6-6-6-6',
  icon: function icon() {
    return /*#__PURE__*/React.createElement("svg", {
      className: (0, _classnames.default)('at-svg', 'at-w', 'at-h'),
...
SixColumnsOptionsCloned.push(_options.CustomColumnOption);
