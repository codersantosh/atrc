...
var AtrcControlFlexDirectionDevice = function AtrcControlFlexDirectionDevice(props) {
  ...
  return /*#__PURE__*/React.createElement(_controlSelectButtonDevice.default, _extends({
    className: (0, _classnames.default)((0, _prefixVars.default)('ctrl-flx-dir-device'), className, variant ? (0, _prefixVars.default)('ctrl-flx-dir-device') + '-' + variant : ''),
    options: _options.default,
    value: value,
    onChange: onChange
  }, defaultProps));
};
var _default = exports.default = AtrcControlFlexDirectionDevice;
