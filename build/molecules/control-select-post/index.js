...
var _getPosts = _interopRequireDefault(require("../../api/get-posts"));
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* WordPress*/ /*Library*/ /*Inbuilt */ /* API */
/* Local*/
var perPage = 100;
        ...
        case 3:
          ...
          if (getPostTypesPosts) {
            options = getPostTypesPosts.map(function (item) {
              return {
                value: item.id,
                label: item.title.rendered || (0, _i18n.__)('Untitled', 'atrc-prefix-atrc')
              };
            });
          }
...
function AtrcControlSelectPost(props) {
  var _props$label = props.label,
    label = _props$label === void 0 ? (0, _i18n.__)('Posts', 'atrc-prefix-atrc') : _props$label,
  ...
  var options = (0, _element.useMemo)(function () {
    return (posts !== null && posts !== void 0 ? posts : []).map(function (post) {
      return {
        value: post.id,
        label: post.title.rendered || (0, _i18n.__)('Untitled', 'atrc-prefix-atrc')
      };
    });
  }, [posts]);
  ...
  if (!options || !options.length) {
    return /*#__PURE__*/React.createElement(_notice.default, {
      autoDismiss: false,
      isDismissible: false
    }, (0, _i18n.__)('No posts found!', 'atrc-prefix-atrc'));
  }
  if (isAsync) {
    if (hasFixNotice) {
      return /*#__PURE__*/React.createElement(_notice.default, {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              newQueryArgs = (0, _lodash.clone)(queryArgs);
    ...
    return /*#__PURE__*/React.createElement(_select4.AtrcDynamicSelect, _extends({
      label: label,
      className: (0, _classnames.default)((0, _prefixVars.default)('ctrl-select-post'), className, variant ? (0, _prefixVars.default)('ctrl-select-post') + '-' + variant : ''),
...
var _default = exports.default = AtrcControlSelectPost;
