...
var AlignSelfOptions = [{
  label: (0, _i18n.__)('Align self start', 'atrc-prefix-atrc'),
  value: 'st',
  icon: function icon() {
  ...
  label: (0, _i18n.__)('Align self end', 'atrc-prefix-atrc'),
  value: 'end',
  icon: function icon() {
    return /*#__PURE__*/React.createElement("svg", {
      className: "at-svg at-w at-h",
  ...
  label: (0, _i18n.__)('Align self center', 'atrc-prefix-atrc'),
  value: 'ctr',
  icon: function icon() {
    return /*#__PURE__*/React.createElement("svg", {
      className: "at-svg at-w at-h",
  ...
  label: (0, _i18n.__)('Align self baseline', 'atrc-prefix-atrc'),
  value: 'bsln',
  icon: function icon() {
    return /*#__PURE__*/React.createElement("svg", {
      className: "at-svg at-w at-h",
  ...
  label: (0, _i18n.__)('Align self stretch', 'atrc-prefix-atrc'),
  value: 'strh',
  icon: function icon() {
    return /*#__PURE__*/React.createElement("svg", {
      className: "at-svg at-w at-h",
...
var _default = exports.default = AlignSelfOptions;
