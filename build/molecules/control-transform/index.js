...
/*Local Components*/
export const AtrcControlTransformAllowedKeys = ['on3D', 'translX', 'translY', 'translZ', 'rotA', 'rotX', 'rotY', 'rotZ', 'sclX', 'sclY', 'sclZ', 'skewX', 'skewY'];
const RenderTabPanel = ({
  ...
  if ('translate' === tab) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AtrcLabel, null, label), /*#__PURE__*/React.createElement(AtrcPanelRow, {
