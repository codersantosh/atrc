...
const AtrcControlDropdownColorGradientTab = props => {
  ...
  const AllTabs = useMemo(() => {
    ...
    if (allowedTabs.includes('normal'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('normal', value, AtrcControlDropdownColorGradientAllowedKeys))
      });
    }
    if (allowedTabs.includes('hover'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('Hover', value, AtrcControlDropdownColorGradientAllowedKeys))
      });
    }
    if (allowedTabs.includes('active'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('Active', value, AtrcControlDropdownColorGradientAllowedKeys))
      });
    }
    if (allowedTabs.includes('focus'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('Focus', value, AtrcControlDropdownColorGradientAllowedKeys))
      });
    }
    if (allowedTabs.includes('visited'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('Visited', value, AtrcControlDropdownColorGradientAllowedKeys))
      });
    }
    if (allowedTabs.includes('parenthover'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('ParentHover', value, AtrcControlDropdownColorGradientAllowedKeys))
      });
    }
    return tabs;
  }, [value]);
  return /*#__PURE__*/React.createElement(AtrcPanelTools, _extends({
    ...
    allowTabs: true,
    tools: AllTabs
  }, defaultProps), activeItems => map(activeItems, (tab, iDx) => /*#__PURE__*/React.createElement(RenderTabPanel, {
    value: value,
