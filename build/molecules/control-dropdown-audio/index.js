...
var _controlAudio = _interopRequireDefault(require("../control-audio"));
  ...
  return /*#__PURE__*/React.createElement(_dropdown.default, _extends({
    ...
    renderToggle: function renderToggle(_ref) {
      ...
      return isToolbar ? /*#__PURE__*/React.createElement(_components.ToolbarButton, {
        name: "img",
        title: (0, _i18n.__)('Select audio', 'atrc-prefix-atrc'),
        onClick: onToggle,
        isActive: false
    ...
    renderContent: function renderContent() {
      return /*#__PURE__*/React.createElement(_controlAudio.default, {
        label: (0, _i18n.__)('Audio', 'atrc-prefix-atrc'),
        value: value,
        onChange: onChange,
        allowSettings: false
      });
...
var _default = exports.default = AtrcControlDropdownAudio;
