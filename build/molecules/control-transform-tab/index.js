...
const RenderTabPanel = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AtrcPanelRow, {
    ...
    resetAll: () => onChange(AtrcResetTabs(value, AtrcControlTransformAllowedKeys)),
    allowTabs: true,
    tools: AllTabs
  }, activeInnerItems => map(activeInnerItems, (innerTab, iDx1) => /*#__PURE__*/React.createElement(Fragment, {
    key: iDx1 + innerTab
    ...
    isDismissible: false,
    autoDismiss: false
  }, __('For a smooth transformation on hover, use the transition options properly.', 'atrc-prefix-atrc')) : null))), /*#__PURE__*/React.createElement(AtrcPanelTools, {
    label: __('Origin', 'atrc-prefix-atrc'),
    resetAll: resetOrigin,
    tools: OriginTabs
  }, activeInnerItems => map(activeInnerItems, (tab2, iDx2) => /*#__PURE__*/React.createElement(AtrcOrigin, {
    value: {
  ...
  const AllTabs = useMemo(() => {
    ...
    if (allowedTabs.includes('normal'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('normal', value, AtrcControlTransformAllowedKeys))
      });
    }
    if (allowedTabs.includes('hover'.toLowerCase())) {
      tabs.push({
        ...
        onDeselect: () => onChange(AtrcResetTab('Hover', value, AtrcControlTransformAllowedKeys))
      });
    }
    if (allowedTabs.includes('parenthover'.toLowerCase())) {
      tabs.push({
        ...
        hasValue: AtrcHasTabValues('ParentHover', value, AtrcControlTransformAllowedKeys),
        onDeselect: () => onChange(AtrcResetTab('ParentHover', value, AtrcControlTransformAllowedKeys))
      });
    }
    return tabs;
  }, [value]);
