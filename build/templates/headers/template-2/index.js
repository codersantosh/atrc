...
var MapElements = function MapElements(_ref) {
  ...
  return elements.map(function (element, iDx) {
    ...
    if ('bulkCheck' === element) {
      ...
      }, /*#__PURE__*/React.createElement(AtrcControlCheckbox, atrcProps.bulkCheck.checkProps), atrcProps.bulkCheck.checkedIds.length > 0 && atrcProps.bulkCheck.actions ? /*#__PURE__*/React.createElement(AtrcButtonGroup, {
...
var AtrcHeaderTemplate2 = function AtrcHeaderTemplate2(props) {
