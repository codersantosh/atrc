...
var RenderComponent = function RenderComponent(props) {
  ...
  return /*#__PURE__*/React.createElement(TextareaControl, _extends({
    className: classnames(AtrcPrefix('ctrl-txt-area'), className, variant ? AtrcPrefix('ctrl-txt-area') + '-' + variant : ''),
    value: value
  }, defaultProps));
};
var AtrcControlTextarea = function AtrcControlTextarea(props) {
