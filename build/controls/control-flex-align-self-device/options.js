...
/* Align Options*/
var AlignSelfOptions = function AlignSelfOptions() {
  return [{
    label: __('Align self start', 'atrc-prefix-atrc'),
    value: 'st',
    ...
    label: __('Align self end', 'atrc-prefix-atrc'),
    value: 'end',
    ...
    label: __('Align self center', 'atrc-prefix-atrc'),
    value: 'ctr',
    ...
    label: __('Align self baseline', 'atrc-prefix-atrc'),
    value: 'bsln',
    ...
    label: __('Align self stretch', 'atrc-prefix-atrc'),
    value: 'strh',
...
export default AlignSelfOptions;
