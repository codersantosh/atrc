...
var _excluded = ["className", "variant"],
  _excluded2 = ["svg", "variant", "className"],
  _excluded3 = ["iconUrl", "className"],
...
/*Local*/
export var AtrcIconWp = function AtrcIconWp(props) {
  ...
  return /*#__PURE__*/React.createElement(Icon, _extends({
    className: classnames(AtrcPrefix('svg'), className, variant ? AtrcPrefix('svg') + '-' + variant : '')
  }, defaultProps));
};
export var AtrcIconSvg = function AtrcIconSvg(props) {
  var svg = props.svg,
  ...
  return hasHtmlTags ? /*#__PURE__*/React.createElement("span", _extends({
    className: classnames(className, AtrcPrefix('svg-wrp'), variant ? AtrcPrefix('svg') + '-' + variant : ''),
...
export var AtrcIconUrl = function AtrcIconUrl(props) {
  ...
  useEffect(function () {
    ...
    function _fetchIcon() {
      _fetchIcon = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
var AtrcIcon = function AtrcIcon(props) {
  var _props$className4 = props.className,
    className = _props$className4 === void 0 ? '' : _props$className4,
    _props$variant3 = props.variant,
    variant = _props$variant3 === void 0 ? '' : _props$variant3,
    _props$type = props.type,
    type = _props$type === void 0 ? 'wp' : _props$type,
    _props$svg = props.svg,
    svg = _props$svg === void 0 ? '' : _props$svg,
  ...
  if (typeof icon === 'function') {
    return icon(_objectSpread({
      className: classnames(AtrcPrefix('svg'), 'at-w', 'at-h', className, variant ? AtrcPrefix('svg') + '-' + variant : '')
    }, defaultProps));
  }
  ...
  if (type === 'svg') {
    return /*#__PURE__*/React.createElement(AtrcIconSvg, props);
  }
  if ('url' === type) {
