...
var AtrcLabel = function AtrcLabel(props) {
  ...
  return /*#__PURE__*/React.createElement("label", _extends({
    className: (0, _classnames.default)((0, _prefixVars.default)('lbl'), 'at-m', className, variant ? (0, _prefixVars.default)('lbl') + '-' + variant : ''),
    htmlFor: htmlFor
  }, defaultProps), children);
};
var _default = exports.default = AtrcLabel;
